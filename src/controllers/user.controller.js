...
export const getUserChannelProfile = asyncHandler(async (req, res) => {
    try {
        ...
        throw new ApiError(
            400,
            error?.message || "Error in fetching User Channel details "
        );
    }
});
...
export const getWatchHistory = asyncHandler(async (req, res) => {
    try {
        ...
        console.log("Succesfully fetched watch history: ", user);
        ...
        throw new ApiError(400, "Error in fetching user watch history");
    }
});
